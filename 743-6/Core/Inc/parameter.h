...
//RTC setup
uint8_t RTC_read[] = 	{ 0x5A, 0xA5, 0x04, 0x83, 0x13, 0xA0, 0x0B };//RTC READ, year-month-date-time-minute-second
uint8_t RTC_dial[] = 	{ 0x5A, 0xA5, 0x0B, 0x82, 0x00, 0x9C, 0x5A, 0xA5, 0x32, 0x0A, 0x01, 0x03, 0x00, 0x0D };//RTC READ, year-month-date-time-minute-second
uint8_t RTC_disp[] = 	{ 0x5A, 0xA5, 0x0B, 0x82, 0x00, 0x10, 0x14, 0x02, 0x16, 0x06, 0x0B, 0x0C, 0x0D, 0x00 };
